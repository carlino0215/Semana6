            ...
            items(state.listaUsuarios) {
                Box(
                    ...
                    Column(
                        ...
                        Text(text = it.rut)
                        Text(text = it.nombreApellido)
                        Text(text = it.fechaIngreso)
                        Text(text = it.fechaSalida)
                        Text(text = it.horaIngreso)
                        Text(text = it.horaSalida)
                        Text(text = it.deptoCasa)
                        IconButton(
                            onClick = { navController.navigate("editar/${it.id}/${it.rut}/${it.nombreApellido}/${it.fechaIngreso}/${it.fechaSalida}/${it.horaIngreso}/${it.horaSalida}/${it.deptoCasa}") }
                        ) {
